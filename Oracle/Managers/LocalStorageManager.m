...
{
    static LocalStorageManager * sharedLocalStorageManager = nil;
    static dispatch_once_t onceToken = 0;
    dispatch_once(&onceToken, ^{
        sharedLocalStorageManager = [[LocalStorageManager alloc] init];
    });
    return sharedLocalStorageManager;
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Oracle" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [NSURL fileURLWithPath:[[[NSFileManager defaultManager] applicationDocumentsDirectory] stringByAppendingPathComponent:@"Oracle.sqlite"]];
    NSError *error = nil;
